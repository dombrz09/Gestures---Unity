...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence, String gestureName, GesturesManager gesturesManager)
        {
                ...
                if (this.Detected)
                {
                    ...
                    if (detectionConfidence > 0.35) {
                        if (gestureName == "start_stop")
                        {
                            ...
                            if (gesturesManager.getGestureFlag() != gestureName)
                            {
                                gesturesManager.setGestureFlag(gestureName);
